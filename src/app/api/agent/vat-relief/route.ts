...
// Proxy SSE verso l'agente Agevolazioni (IVA 4% L.104) di studio-server.
// Stesso pattern del proxy price-guard: inoltra il cookie kyron-rev e, in dev,
...
export async function POST(req: NextRequest) {
  ...
  const upstream = await fetch(`${STUDIO_SERVER_URL}/agents/vat-relief`, {
    method: "POST",
    headers: {
