// Skeleton della pagina Clienti. Deve avere la forma del workspace vero
// (CustomersWorkspace): colonna piena a sinistra — testata ferma + lista che
  ...
  return (
    <div className="flex h-full min-h-0 overflow-hidden lg:flex-row">
      <div className="flex min-h-0 min-w-0 flex-1 flex-col animate-pulse">
        {/* Testata: tile stato, ricerca, filtri (stessi padding di CustomersHeader). */}
